...
from modelo.pelicula_dao import crear_tabla, borrar_tabla
from modelo.pelicula_dao import Pelicula, guardar, listar, editar, eliminar
...
class Frame(tk.Frame):
    ...
    # Entrys: campos de entrada
        ...
        self.entry_nombre.config(
            width=50, font=('Times New Roman', 12,'bold'))
    ...
    # Botones, nuevo, guardar y cancelar
        ...
        fg= '#DAD5D6', bg='#1658A2', cursor='hand2', activebackground='#3586BD')
    ...
    def habilitar_campos(self):
        ...
        # Para tener los campos vacios y deshabilitados
    ...
    def tabla_peliculas(self):
        # Recuperar lista peliculas
        self.lista_pelis = listar()
        self.lista_pelis.reverse()
        ...
        # Scrollbar para navegar por los registros
        ...
        # Boton de SALIR
        self.boton_fin = tk.Button(self, text='Finalizar', command= self.root.destroy)
        self.boton_fin.config(width=20, font=('Times New Roman', 12,'bold'),
        fg= '#DAD5D6', bg='#4D4E4C', cursor='hand2', activebackground='#252524')
        self.boton_fin.grid(row=5, column=2, padx=10, pady=10)
